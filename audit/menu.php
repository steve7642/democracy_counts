    ...
    if( empty( $outOfRange ))	{
		   	...
		   	if( $_SESSION['userLevel'] == 0 ){ // supervisor 
		   		 ...
		   		 ";
			   		  ...
			   		  echo "<div style='padding-left:12px; padding-top:18px; padding-bottom:8px; background-color:lightblue; ' > 
							   		    <div style='padding-top:1px; ' > <a href='vote.php'> Intake page </a> </div>  
							   		    <div style='padding-top:18px; ' > <a href='vote.php?v=1'> Voting page </a> </div> 
							   		    <div style='padding-top:18px; ' > <a href='nonVoter.php'> Non-Voter  </a> </div> 
							   		    <div style='padding-top:18px; '> <a href='logout-page.php'> Logout </a> </div> 
			   		        </div> </td> 
