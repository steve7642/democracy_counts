<?php // https://coa520.com/voter/reports.php   
include "header.php"; 	
?> 
...
?>
  <form method=post name=ff > 	
  	<input type=hidden name=reportType value=''>	
		...
		<?php  
		    //include "menu.php"; 
		   	echo "<td style='padding-top:20px; padding-left:20px; ' > <strong> Choose Report for download </strong> 
				...
				// SELECT f1,f2,f3 p from generic_list where listType='votes'
							      ...
							      echo "<script> document.target='_blank'; document.location='https://coa520.com/audit/out_csv/intake.csv'; </script>";   
